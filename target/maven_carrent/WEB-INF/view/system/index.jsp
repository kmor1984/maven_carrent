...
<body class="easyui-layout">
    ...
    <div class="wu-main" data-options="region:'center',split:true,border:true">
       <div id="wu-tabs" class="easyui-tabs" data-options="border:false,fit:true">  
            <div title="首页" data-options="href:'${ctx }/desk/toDesk.action',closable:false,iconCls:'icon-tip',cls:'pd3'"></div>
        </div>
    </div>
    <!-- end of main --> 
    <!-- begin of footer -->
	<div class="wu-footer" data-options="region:'south',border:true,split:true">
    	&copy; <font color=blue>========“我的老婆是警察”版权所有@ All Rights Reserved=========</font>
    </div>
    ...
    <SCRIPT type="text/javascript">
		...
		$(document).ready(function(){
			var url="${ctx}/login/loadTreeMenu.action";
